...
function template_main()
{
	...
	<div class="tborder topic_table" id="messageindex">
		...
		{
			echo '
				<th scope="col" width="8%" colspan="2">&nbsp;
					<div class="cat_bar">
						<h3 class="catbg">&nbsp;</h3>
					</div>
				</th>
				...
				if (!empty($context['can_quick_mod']) && $options['display_quick_mod'] == 1) {
							...
							<div class="cat_bar">
								<h3 class="catbg">';
									if (empty($context['can_quick_mod']))
										echo '<a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=last_post', $context['sort_by'] == 'last_post' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['last_post'], $context['sort_by'] == 'last_post' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a>';
									else
										echo '<a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=last_post', $context['sort_by'] == 'last_post' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['last_post'], $context['sort_by'] == 'last_post' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a>';
								echo'
								</h3>
					...
					echo'
						<th scope="col" width="28%" colspan="2">&nbsp;
							<div class="cat_bar">
								<h3 class="catbg">';
									if (empty($context['can_quick_mod']))
										echo '<a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=last_post', $context['sort_by'] == 'last_post' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['last_post'], $context['sort_by'] == 'last_post' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a>';
		...
		foreach ($context['topics'] as $topic)
		{
			...
			if ($topic['new'] && $context['user']['is_logged'])
					echo '
							<a href="', $topic['new_href'], '" id="newicon' . $topic['first_post']['id'] . '"><img src="', $settings['lang_images_url'], '/new'.$context['theme_variant'].'.gif" alt="', $txt['new'], '" /></a>';
		...
		if (!empty($context['can_quick_mod']) && $options['display_quick_mod'] == 1 && !empty($context['topics']))
		{
			echo '
				<tr class="titlebg">
					<td colspan="6" align="right" style="border-top: 3px solid #fff; border-bottom: none">

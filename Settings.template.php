...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		array(
			'id' => 'Disable_Col',
			'label' => $txt['DisableCol'],
			'description' => $txt['DisableCol_desc'],
		),
		array(
			'id' => 'header_title1',
			'label' => $txt['title_white'],
			'description' => $txt['title_white_desc'],
			'type' => 'text',
			'size' => 18,
		),
		array(
			'id' => 'header_title2',
			'label' => $txt['title_orange'],
			'description' => $txt['title_orange_desc'],
			'type' => 'text',
			'size' => 18,
		),
		array(
